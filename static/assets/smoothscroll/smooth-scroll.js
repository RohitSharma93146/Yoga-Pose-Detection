(function () {
    function C() {
        if (!D && document.body) {
            ...
            if (top != self) v = !0;
                ...
                ca &&
                c > d &&
                (a.offsetHeight <= d || b.offsetHeight <= d)
            ) {
    ...
    function M(a) {
        ...
        if (
            ...
            if (-1 != document.URL.indexOf("www.youtube.com/watch")) {
                do if ((h = c.classList && c.classList.contains("html5-video-controls")))
                    break;
    ...
    function S(a) {
        ...
        do {
            ...
            if (c === a.scrollHeight) {
                if (
                    ((e = X(l) && X(d)) || Y(l),
                    v && l.clientHeight + 10 < l.scrollHeight) ||
                    (!v && e)
                )
                    return I(b, O());
    ...
    function fa(a) {
        var b = J(a);
        null == A[b] &&
            (a = getComputedStyle(a, "")["scroll-behavior"], (A[b] = "smooth" == a));
        return A[b];
    }
    function r(a, b) {
