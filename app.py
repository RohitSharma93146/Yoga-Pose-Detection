...
def classifyPose(landmarks, output_image, display=False):
    ...
    # Check for Warrior I Pose
    if (left_elbow_angle > 165 and left_elbow_angle < 195 and
            right_elbow_angle > 165 and right_elbow_angle < 195 and
            left_shoulder_angle > 165 and left_shoulder_angle < 195 and
            right_shoulder_angle > 165 and right_shoulder_angle < 195):
        if ((left_knee_angle > 90 and left_knee_angle < 165 and
                right_knee_angle > 165 and right_knee_angle < 195) or (left_knee_angle > 165 and left_knee_angle < 195 and
                right_knee_angle > 90 and right_knee_angle < 165)):
            # if (left_knee_angle > 90 and left_knee_angle < 120 or
            #         right_knee_angle > 90 and right_knee_angle < 120):
                label = 'Virabhadrasana I (Warrior I Pose)'
    ...
    if (left_elbow_angle > 165 and left_elbow_angle < 195 and
        ...
        if (left_knee_angle > 165 and left_knee_angle < 195 or
            ...
            # if (left_knee_angle > 90 and left_knee_angle < 120 or
            #         right_knee_angle > 90 and right_knee_angle < 120):
                label = 'Virabhadrasana II (Warrior II Pose)'
    ...
    if (left_elbow_angle > 165 and left_elbow_angle < 195 and
        ...
        label = 'Bind Pose or Reference Pose (T Pose)'
    ...
    # Check for Pranamasana (Prayer Pose)
    if (
            right_elbow_angle > 5 and right_elbow_angle < 95 and
            right_shoulder_angle > 5 and right_shoulder_angle < 110 and
            left_knee_angle > 160 and left_knee_angle < 195 and
            right_knee_angle > 160 and right_knee_angle < 195):
        label = 'Pranamasana (Prayer Pose)'


    # # Check for Mountain Pose (Tadasana)
    if (left_elbow_angle > 165 and left_elbow_angle < 195 and
            right_elbow_angle > 165 and right_elbow_angle < 195 and
            left_shoulder_angle > 20 and left_shoulder_angle < 60 and
            right_shoulder_angle > 20 and right_shoulder_angle < 60 and
            left_knee_angle > 160 and left_knee_angle < 195 and
            right_knee_angle > 160 and right_knee_angle < 195):
